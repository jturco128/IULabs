...
public partial class admin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DateTime time = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 6,0,0);

        DataRowCollection RS = SQLstar.GetRecordset("Lab", "SELECT * FROM LabSchedule WHERE lab_id = 1;");
